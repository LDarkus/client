...
import { GetDirections,  CreateDiscipline } from '../../services/ApiService';
...
onMounted(() => {
    GetDirections().then(res => { directions.value = res; console.log(directions.value[0].groups[0]); })

})
const test = () => console.log(year.value);
</script>
